    ...
    <div className="flex h-full w-full bg-[#0d1117] overflow-hidden">
      ...
      <div className="flex-1 min-w-0 h-full relative border-r border-white/10">
        ...
        {tabs.map(tab => (
          ...
          >
            {/* We render the standalone terminal, which has its own header. 
                In a future iteration we could strip its header when in IDE mode, 
                but for now it's fine since it provides maximize/minimize tools. */}
