...
export function useAppController() {
  ...
  function toggleGlobalActionBar(): void {
    setGlobalActionBarOpen((value) => !value)
  }
  ...
  const globalActions = [
    ...
    { id: 'toggle-console', label: 'Toggle Console', icon: <TerminalSquare className="h-4 w-4" />, execute: toggleConsole },
  ...
  return {
    ...
    workspacePanelsProps: {
      ...
      keepIdeMounted,
      multiplexContent,
      onChangeDefaultSessionStrategy: (strategy: SessionWorkspaceStrategy) => { void handleChangeDefaultSessionStrategy(strategy) },
      onFileSelect: (file: SelectedFileEntry) => {
        setSelectedFile(file)
        setGlobalMode('ide')
      },
      onOpenProject: () => { void handleOpenProject() },
      onRefreshProject: () => { void handleRefreshProject() },
      onTabClose: (tabId: string) => { void handleCloseTab(tabId) },
