  ...
  return (
    <section className="border-t border-white/10 bg-black/30 px-8 py-3">
      <div className="mb-3 flex items-center justify-between gap-4">
        <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-sentinel-mist">
          Global Activity Log
        </div>
      ...
      <div className="grid h-[118px] min-h-0 gap-2 overflow-hidden">
        {visibleEntries.length === 0 ? (
          ...
          visibleEntries.map((entry) => (
            ...
            >
              <div className="font-mono text-sentinel-mist">
              ...
              <div className="min-w-0 font-mono text-sentinel-mist">
                ...
                {entry.detail && (
                  <div className="truncate text-[11px] text-rose-200/80">
                    {entry.detail}
                  </div>
                )}
              </div>
